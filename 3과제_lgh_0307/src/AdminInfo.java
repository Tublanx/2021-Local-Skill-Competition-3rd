	...
	public AdminInfo() {
		...
		try {
			var rs = stmt.executeQuery(
					"select c.c_name, e.e_title, e.e_people, format(e.e_pay, '#,##0'), c.c_category, c.c_address, e.e_graduate, e.e_gender, e.e_no from employment e, company c, applicant a where e.c_no = c.c_no and a.e_no = e.e_no and (a.a_apply = 0 or a.a_apply = 1) group by e.e_no");
			while (rs.next()) {
